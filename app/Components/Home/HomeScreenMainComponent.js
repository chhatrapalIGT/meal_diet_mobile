    ...
    <View style={styles.homeScreenMainContainer}>
      <View style={styles.homeHeaderMainView}>
        <View style={styles.homeHeaderContent}>
          ...
          >
            <Image source={images.backIcon} style={styles.arraowImage} />
          </Pressable>
          ...
          <Pressable
            ...
            disabled={daysbuttonDisabled}
          >
            <Image source={images.forwordIcon} style={styles.arraowImage} />
          </Pressable>
        </View>
      </View>
            ...
            {mealList.length > 0 ? (
              <>
                {mealList.map((meal, index) => {
                  return (
                    <View key={`meal_${index}`} style={styles.mealListMainView}>
                      <View style={styles.mealListLeftMainView}>
                        <View style={styles.mealListLeftMainWapper}>
                          <Text
                            style={{
                              color: index % 2 === 0 ? "#085A5F" : "#6ED2D9",
                          ...
                          {meal.Items.map((item, itemIndex) => {
                            return (
                              <>
                                {item.Type === "Food item" && (
                                  <Text style={styles.mealListItemText}>
                                ...
                                {item.Type === "Recipe" && (
                                  <View key={itemIndex}>
                                    ...
                                    >
                                      <Text style={styles.mealListItemReadMore}>
                                        {`${translations[currentLanguage].seeRecipeIdea}->`}
                                      </Text>
                                    </Pressable>
                                  </View>
                                )}
                      ...
                      <View style={styles.mealListRightView}>
                        <Image
                          source={images.foodImage}
                          style={styles.mealListRightImage}
                          resizeMode="cover"
                        />
                      </View>
                    </View>
